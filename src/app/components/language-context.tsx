...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    // Hero
    heroKicker: "Senior Frontend Developer",
    heroName: "Vasile Eduard Bogdan",
    heroRole: "Senior frontend developer",
    ...
    heroNavWork: "Work",
    heroNavPersonalProjects: "Personal projects",
    heroNavCV: "CV",
    heroNavContact: "Contact",
    ...
    heroSkillFrontend: "Frontend",
    heroSkillFrontendItems: "Nuxt · Vue · TypeScript",
    heroSkillMotion: "Motion & interaction",
    heroSkillMotionItems: "GSAP · Lenis · Three.js",
    heroSkillAudio: "Audio & music",
    heroSkillAudioItems: "Web Audio API · Essentia",
    heroSkillCreative: "Creative & AI",
    heroSkillCreativeItems: "AI tools · Visual design",
    heroHeadline: "It's not about the tools, it's about who is behind them.",
    heroIntro:
      "I build scalable UI systems, motion-driven product interfaces, and premium frontend experiences for modern digital products.",
    heroPrimaryCta: "View CV",
    heroSecondaryCta: "View Selected Work",
    heroTag1: "Design Systems",
    heroTag2: "Motion UI",
    heroTag3: "Product Frontend",
    heroTag4: "Performance",
    heroPhaseSystemsTitle: "Scalable UI Systems",
    heroPhaseSystemsBody: "Floating components reorganize into structured layouts—buttons, cards, tokens, and grids forming a cohesive design system.",
    heroPhaseMotionTitle: "Motion With Purpose",
    heroPhaseMotionBody: "Every element responds with inertia, depth, and cinematic easing—turning interface craft into an immersive product story.",
    heroPhaseProductTitle: "Product-Ready Engineering",
    heroPhaseProductBody: "From dashboards to ecommerce cards, the system assembles into real interfaces built for performance and premium UX.",
  ...
  ro: {
    ...
    heroKicker: "Senior Frontend Developer",
    heroName: "Vasile Eduard Bogdan",
    heroRole: "Dezvoltator frontend senior",
    ...
    heroNavPersonalProjects: "Proiecte personale",
    heroNavCV: "CV",
    heroNavContact: "Contact",
    heroQuote: "Nu contează uneltele; contează cine stă în spatele lor.",
    heroQuoteBy: "de Vasile Eduard Bogdan",
    heroScrollHint: "Derulează pentru a explora",
    heroSkillFrontend: "Frontend",
    heroSkillFrontendItems: "Nuxt · Vue · TypeScript",
    heroSkillMotion: "Motion & interacțiune",
    heroSkillMotionItems: "GSAP · Lenis · Three.js",
    heroSkillAudio: "Audio & muzică",
    heroSkillAudioItems: "Web Audio API · Essentia",
    heroSkillCreative: "Creative & AI",
    heroSkillCreativeItems: "Unelte AI · Design vizual",
    heroHeadline: "Interfețe Premium Cu Motion",
    heroIntro:
      "Construiesc sisteme UI scalabile, interfețe de produs cu motion și experiențe frontend premium pentru produse digitale moderne.",
    heroPrimaryCta: "Vezi CV",
    heroSecondaryCta: "Vezi proiectele selectate",
    heroTag1: "Design Systems",
    heroTag2: "Motion UI",
    heroTag3: "Product Frontend",
    heroTag4: "Performance",
    heroPhaseSystemsTitle: "Sisteme UI Scalabile",
    heroPhaseSystemsBody: "Componentele plutitoare se reorganizează în layout-uri structurate—butoane, carduri, token-uri și grile care formează un design system coerent.",
    heroPhaseMotionTitle: "Motion Cu Scop",
    heroPhaseMotionBody: "Fiecare element răspunde cu inerție, adâncime și easing cinematic—transformând craft-ul de interfață într-o poveste de produs imersivă.",
    heroPhaseProductTitle: "Inginerie Product-Ready",
    heroPhaseProductBody: "De la dashboard-uri la carduri e-commerce, sistemul se asamblează în interfețe reale construite pentru performanță și UX premium.",
